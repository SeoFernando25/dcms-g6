...
@Component({
  ...
  styleUrls: ['./update-my-review.component.scss', './../my-review/my-review.component.scss']
})
export class UpdateMyReviewComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.editData.professionalism_score = (this.editData.professionalism_score).toString();
    this.editData.cleanliness_score = (this.editData.cleanliness_score).toString();
    this.editData.communication_score = (this.editData.communication_score).toString();
  ...
  UpdateReview() {
    ...
    sb.from('review').update({
      review_date: this.UpdateReviewForm.value.review_date,
      professionalism_score: this.UpdateReviewForm.value.professionalism_score,
      ...
      'review_id', this.editData.review_id).then((data) => {
        if(data.error) {
